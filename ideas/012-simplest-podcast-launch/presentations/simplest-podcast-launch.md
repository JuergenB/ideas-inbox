...
<div style="display: flex; flex-direction: column; gap: 10px; margin-top: 16px;">
  <div class="row" style="display: flex; align-items: center; gap: 18px;"><div style="font-family: 'Outfit'; font-weight: 700; font-size: 1.3em; color: var(--a); width: 34px;">1</div><div style="font-size: 0.8em; color: var(--body);"><strong>Open your studio.</strong> Your reusable recording room in Riverside — the same one every time, set up once.</div></div>
  <div class="row" style="display: flex; align-items: center; gap: 18px;"><div style="font-family: 'Outfit'; font-weight: 700; font-size: 1.3em; color: var(--a); width: 34px;">2</div><div style="font-size: 0.8em; color: var(--body);"><strong>Invite your guest.</strong> Add their email and Riverside sends the link — or copy the studio link and send it yourself.</div></div>
...
<div style="margin-top: 14px; background: var(--s); border: 1px solid var(--b); border-left: 2px solid var(--a); border-radius: 8px; padding: 12px 18px; font-size: 0.72em; color: var(--body); line-height: 1.55;"><strong>Riverside is the one tool to get comfortable with</strong> — it's yours to drive. Good to know: your <em>studio</em> is one reusable room you set up once, and a recording <em>becomes</em> an episode when you publish it — there's no separate "episode" to create first. It's built to be learned quickly (tutorials at the end).</div>
