...
<div style="display: flex; gap: 11px; margin-top: 16px;">
  <div style="flex: 1; background: var(--s); border: 1px solid var(--b); border-radius: 9px; padding: 13px 14px;">
    <div style="font-family:'Outfit'; font-weight:700; font-size:1.35em; color:var(--a);">14</div>
    <div style="font-size: 0.6em; color: var(--m); line-height:1.3; margin-top:3px;">Open-call listings</div>
  </div>
  <div style="flex: 1; background: var(--s); border: 1px solid var(--b); border-radius: 9px; padding: 13px 14px;">
    <div style="font-family:'Outfit'; font-weight:700; font-size:1.35em; color:var(--blue);">14</div>
...
**Master directory — 61 verified US channels across 5 workstreams, action URLs verified June 2026 (team-refreshed 2026-06-18)** — live Perplexity-built resource: <a href="https://arterial-art-exhibition-promotion-resources.pplx.app/">arterial-art-exhibition-promotion-resources.pplx.app</a>; underlying data in <code>research/arts-master-resource.csv</code>.
